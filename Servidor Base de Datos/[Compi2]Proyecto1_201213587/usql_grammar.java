/* usql_grammar.java */
/* Generated By:JavaCC: Do not edit this line. usql_grammar.java */
package Analisis.Usql;

public class usql_grammar implements usql_grammarConstants {
  public static void main(String args[]) throws ParseException {
    usql_grammar parser = new usql_grammar(System.in);
    parser.S();
  }
...
System.out.println("etntro llamada imprimr");
  ...
  public usql_grammarTokenManager token_source;
  ...
  public usql_grammar(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public usql_grammar(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new usql_grammarTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public usql_grammar(java.io.Reader stream) {
  ...
  public usql_grammar(usql_grammarTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(usql_grammarTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
