...
public class usrGrammar implements usrGrammarConstants {
  ...
  final public ArrayList<Usuario> S() throws ParseException {ArrayList<Usuario> us = new ArrayList<Usuario>();
...
System.out.println("Exito!!");
  ...
  final public ArrayList<Usuario> L_USR() throws ParseException {ArrayList<Usuario> us = new ArrayList<Usuario>(); ArrayList<Usuario> us2 = new ArrayList<Usuario>();
    us = USR();
...
{if ("" != null) return us;}
  ...
  final public ArrayList<Usuario> USR() throws ParseException {String n,p,s; int t,e; ArrayList<PermisosUsr> pu = new ArrayList<PermisosUsr>();
